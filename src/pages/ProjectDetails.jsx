...
console.log(data);
    ...
    return (
        ...
        <div className="min-h-screen">
            <Section>
                <StartingPage
                    title={data.name_project}
                    semiTitle={data.type ? data.type.name : 'N/A'}
                    description={data.description}
                    image={<img src={data.img} className="rounded-2xl object-cover h-full w-full" alt={data.name_project} />}
                />
            </Section>
